...
@Configuration
@ComponentScan(basePackages = {"ru.kpfu.itis.javalab.model", "ru.kpfu.itis.javalab.service"})
@EnableJpaRepositories(basePackages = {"ru.kpfu.itis.javalab.repo"})
...
public class RootConfig {
    ...
    public DataSource dataSource(){
        ...
        managerDataSource.setUrl(env.getProperty("jdbc.uri"));
        managerDataSource.setUsername(env.getProperty("db.user"));
        managerDataSource.setPassword(env.getProperty("db.password"));
